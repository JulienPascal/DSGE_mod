...
%
make_ex_;
set_shocks(0,1:100, 1, shock_vals_A);
set_shocks(0,1:100, 2, shock_vals_L);
M_.exo_det_length = 0;
...
rplot(var_list_);
var_list_=[];
var_list_ = 'g_K_aggregate';
var_list_ = char(var_list_, 'g_K_per_capita');
var_list_ = char(var_list_, 'g_K_intensive');
rplot(var_list_);
var_list_=[];
var_list_ = 'g_Y_aggregate';
var_list_ = char(var_list_, 'g_Y_per_capita');
var_list_ = char(var_list_, 'g_Y_intensive');
rplot(var_list_);
